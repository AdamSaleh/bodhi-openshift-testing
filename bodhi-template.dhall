...
, objects =
    [ < BuildConfig :
      ...
      >.Service
        ...
        , kind = "Service"
        , metadata =
            { labels = { app = "bodhi", service = "web" }, name = "bodhi-web" }
        , spec =
            { ports =
                [ { name = "web"
                  , port = 8080
                ...
                , spec =
                    { containers =
                        [ < C :
                          ...
                          | C_L_R_P :
                              ...
                              , ports :
                                  List
                                    { containerPort : Natural, protocol : Text }
                              , readinessProbe :
                                  { failureThreshold : Natural
                                  , httpGet :
                                      { path : Text
                    ...
                    , volumes =
                        [ < ConfigMap :
                          ...
                          >.ConfigMap
                            { configMap =
                                { defaultMode = 420, name = "bodhi-configmap" }
                            , name = "config-volume"
                            }
                        , < ConfigMap :
                              { configMap :
      ...
      >.DeploymentConfig
        ...
        , spec =
            ...
            , template =
                { metadata =
                    { labels =
                        { app = "bodhi-web", deploymentconfig = "bodhi-web" }
                    }
                , spec =
                    { containers =
                        [ < C :
    ...
    , < BuildConfig :
      ...
      >.BuildConfig
        ...
        , kind = "BuildConfig"
        , metadata = { labels = { build = "bodhi-base" }, name = "bodhi-base" }
        , spec =
            { failedBuildsHistoryLimit =
                5
            , output =
                { to = { kind = "ImageStreamTag", name = "bodhi-base:latest" } }
            , postCommit = {=}
            , resources = {=}
            , runPolicy = "Serial"
            , source =
      ...
      >.BuildConfig
        ...
        , spec =
            { failedBuildsHistoryLimit =
                5
            , output =
                { to = { kind = "ImageStreamTag", name = "bodhi-celery:latest" }
                }
            , postCommit = {=}
            , resources = {=}
            , runPolicy = "Serial"
    ...
    , < BuildConfig :
      ...
      >.BuildConfig
        ...
        , kind = "BuildConfig"
        , metadata =
            { labels = { build = "bodhi-consumer" }, name = "bodhi-consumer" }
        , spec =
            { failedBuildsHistoryLimit = 5
            , output =
                { to =
                    { kind = "ImageStreamTag", name = "bodhi-consumer:latest" }
                }
            , postCommit = {=}
            , resources = {=}
            , runPolicy = "Serial"
    ...
    , < BuildConfig :
      ...
      >.BuildConfig
        { apiVersion = "build.openshift.io/v1"
        , kind = "BuildConfig"
        , metadata = { labels = { build = "bodhi-web" }, name = "bodhi-web" }
        , spec =
            { failedBuildsHistoryLimit = 5
            , output =
                { to = { kind = "ImageStreamTag", name = "bodhi-web:latest" } }
            , postCommit = {=}
            , resources = {=}
            , runPolicy = "Serial"
            , source =
